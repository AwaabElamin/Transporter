                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Text(
                                                                            Languages.of(context)!.dollersignlable +
                                                                                comsearchlist[index].amount.toString(),
                                                                            style: TextStyle(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              Text(
                                                                                ...
                                                                                style: TextStyle(color: Color(Constants.greaytext), fontFamily: Constants.appFont, fontSize: 12),
                                                                              ),
                                                                              Text(
                                                                                "  x " + comsearchlist[index].orderItems![position].qty.toString(),
                                                                                style: TextStyle(color: Color(Constants.greentext), fontFamily: Constants.appFont, fontSize: 12),
                                                                              ),

                                                                              // Text("No",style:TextStyle(color: Color(Constants.greaytext),fontFamily: Constants.appFont,fontSize: 12),),
                                                                              // Text(" ",style:TextStyle(color: Color(Constants.greentext),fontFamily: Constants.appFont,fontSize: 12),),
                                                                            ],
                                                                          ),
                                                                        );
                                                                      },
                                                                                ...
                                                                                children: [
                                                                                    ...
                                                                                    children: [
                                                                                      Container(
                                                                                        ...
                                                                                        child: AutoSizeText(
                                                                                          ...
                                                                                          style: TextStyle(color: Color(Constants.whitetext), fontFamily: Constants.appFontBold, fontSize: 16),
                                                                                        ),
                                                                                      ),
                                                                                      Row(
                                                                                  ...
                                                                                  Container(
                                                                                    ...
                                                                                    child: AutoSizeText(
                                                                                      ...
                                                                                      overflow: TextOverflow.visible,
                                                                                      maxLines: 3,
                                                                                      style: TextStyle(color: Color(Constants.greaytext), fontFamily: Constants.appFont, fontSize: 14),
                                                                                    ),
                                                                                  ),
                                                                                ],
                                                                              ),
                                                                                  ...
                                                                                  children: [
                                                                                    Container(
                                                                                        ...
                                                                                        child: Text(
                                                                                          ...
                                                                                          style: TextStyle(color: Color(Constants.whitetext), fontSize: 16, fontFamily: Constants.appFontBold),
                                                                                        )),
                                                                                    Container(
                                                                                        margin: EdgeInsets.only(left: 5),
                                                                                        child: Text(
                                                                                          "(" + paymentstatus + ")",
                                                                                          style: TextStyle(color: paymentcolor, fontSize: 16, fontFamily: Constants.appFontBold),
                                                                                        )),
                                                                                  ],
                                                                                ),
                                                                                Text(
                                                                                  Languages.of(context)!.cashondeliverylable,
                                                                                  style: TextStyle(color: Color(Constants.greaytext), fontSize: 14, fontFamily: Constants.appFont),
                                                                                )
                                                                              ],
                                                                            ),
                                                                          ),
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              child: Container(
                                                                                  ...
                                                                                  child: Text(
                                                                                    ...
                                                                                    maxLines: 3,
                                                                                    overflow: TextOverflow.visible,
                                                                                    style: TextStyle(color: Color(Constants.greentext), fontSize: 14, fontFamily: Constants.appFont),
                                                                                  )),
                                                                            ),
                                                                          ),
                                                                        ],
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Text(
                                                                            Languages.of(context)!.dollersignlable +
                                                                                " " +
                                                                                comporderdatalist[index].amount.toString(),
                                                                            style: TextStyle(
                                                                                color: Color(Constants.colorTheme),
                                                                                fontFamily: Constants.appFontBold,
                                                                                fontSize: 16),
                                                                              ...
                                                                              children: [
                                                                                Container(
                                                                                    ...
                                                                                    child: Text(
                                                                                      ...
                                                                                      style: TextStyle(color: Color(Constants.redtext), fontSize: 16, fontFamily: Constants.appFont),
                                                                                    )),
                                                                                Visibility(
