...
class _UploadDocument extends State<UploadDocument> {
  ...
  void initState() {
    ...
    if (mounted) {
      setState(() {
        String vehicleType =
            PreferenceUtils.getString(Constants.driversetvehicaltype);
        if (vehicleType != '') {
          var json = JsonDecoder().convert(vehicleType);
          _vehicletype = (json)
              .map<Vehicletype>((item) => Vehicletype.fromJson(item))
              .toList();
                    ...
                    Container(
                        ...
                        child: Row(
                            ...
                            children: [
                              ...
                              // Container(
                              //
                              //   child: Text("Your document file must be in .jpeg, .png or .pdf format.",style:TextStyle(color: Color(Constants.whitetext),fontSize: 14,fontFamily: Constants.appFont),),
                              //
                              // ),
                                ...
                                child: RichText(
                                  ...
                                  text: TextSpan(
                                    children: [
                                      ...
                                      //
                                      //     child: Text("or", style: TextStyle(color: Color(Constants.whitetext), fontSize:13, fontFamily: Constants.appFont,),),),
                                      //
                                      //
                                      // ),
                                      ...
                                      //     margin: EdgeInsets.only(left: 0,top: 0,bottom: 0,right: 5),
                                      //
                                      //     child: Text(" .pdf", style: TextStyle(color: Color(Constants.greentext), fontSize:13, fontFamily: Constants.appFont,),),),
                                      //
                                      //
                                      // ),
