...
import 'package:alnaqel_driver/screen/create_new_account.dart';
...
import 'package:alnaqel_driver/screen/uploaddocumentscreen.dart';
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: SafeArea(
        child: Scaffold(
          key: _scaffoldKey,
          backgroundColor: Color(Constants.colorBlack),
                                              ...
                                              onPressed: () {
                                                ...
                                                if (form!.validate()) {
                                                  ...
                                                  /*if (PreferenceUtils.getString(Constants.driverdevicetoken) == '') {
                                                    getOneSingleToken(PreferenceUtils.getString(Constants.oneSignalAppId));
                                                  } else {
  ...
  callApiForLogin(
    ...
    RestClient(ApiHeader().dioData())
      ...
      if (sucess == true) {
        ...
        print(
            "Name12345:${PreferenceUtils.getString(Constants.driverfirstname)}");
        print(
            "Name123456:${PreferenceUtils.getString(Constants.driverlastname)}");
        ...
        Constants.createSnackBar(
            "Login Successfully", this.context, Color(Constants.greentext));
  ...
  void callApiForsetting() {
    ...
    RestClient(ApiHeader().dioData()).driversetting().then((response) {
      if (response.success == true) {
        ...
        PreferenceUtils.setString(
            Constants.cancelReason, response.data!.cancelReason!);
        ...
        if (PreferenceUtils.getString(Constants.oneSignalAppId) == '') {
          getOneSingleToken(
              PreferenceUtils.getString(Constants.oneSignalAppId));
        }
      } else {}
    }).catchError((Object obj) {
      // pr.hide();
