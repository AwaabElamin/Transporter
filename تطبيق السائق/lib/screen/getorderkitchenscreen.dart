...
import 'package:alnaqel_driver/screen/pickupdeliverorderscreen.dart';
  ...
  void initState() {
    ...
    if (Constants.currentlat != 0.0 && Constants.currentlong != 0.0) {
      setState(() {
        ...
        if (PreferenceUtils.getString(Constants.previosOrderVendorLat) != '') {
          vendor_lat = double.parse(
              PreferenceUtils.getString(Constants.previosOrderVendorLat));
          vendor_lang = double.parse(
              PreferenceUtils.getString(Constants.previosOrderVendorLang));
        }
    ...
    if (mounted) {
      setState(() {
        id = PreferenceUtils.getString(Constants.previosOrderId);
    ...
    if (mounted) {
      RestClient(ApiHeader().dioData())
        ...
        if (sucess = true) {
          ...
          PreferenceUtils.setString(Constants.previosOrderStatus, "PICKUP");
    ...
    if (mounted) {
      RestClient(ApiHeader().dioData())
        ...
        if (sucess = true) {
          ...
          if (mounted) {
            setState(() {
              PreferenceUtils.setString(Constants.previosOrderStatus, "CANCEL");
                        ...
                        child: Card(
                          ...
                          child: Padding(
                            ...
                            child: TextFormField(
                              ...
                              controller: _text_cancelReason_controller,
                              maxLines: 5,
                              style: TextStyle(
                                  color: Colors.white,
                                  fontSize: 16,
                      ...
                      InkWell(
                        onTap: () {
                          ...
                          if (_cancelReason == "1") {
                            ...
                            if (_text_cancelReason_controller.text.length ==
                                0) {
                              Constants.toastMessage(
                                  Languages.of(context)!.addreasonlable);
                            } else {
                              _cancelReason =
                                  _text_cancelReason_controller.text;
                            }
                          } else {
                            Constants.checkNetwork().whenComplete(() =>
        ...
        try {
          ...
          PolylineResult result =
              await polylinePoints.getRouteBetweenCoordinates(
                  'AIzaSyDOz5oWyuWCeyh-9c1W5gexDzRakcRP-eM',
