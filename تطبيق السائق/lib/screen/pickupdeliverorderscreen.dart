...
import 'package:alnaqel_driver/screen/orderdeliverdscreen.dart';
  ...
  void initState() {
    ...
    if (Constants.currentlat != 0.0 && Constants.currentlong != 0.0) {
      setState(() {
        user_lat = double.parse(
            PreferenceUtils.getString(Constants.previosOrderUserLat));
        user_lang = double.parse(
            PreferenceUtils.getString(Constants.previosOrderUserLang));
    ...
    if (mounted) {
      setState(() {
        ...
        username = PreferenceUtils.getString(Constants.previosOrderUserName);
        useraddress =
            PreferenceUtils.getString(Constants.previosOrderUserAddress);
        user_lat = double.parse(
            PreferenceUtils.getString(Constants.previosOrderUserLat));
        user_lang = double.parse(
            PreferenceUtils.getString(Constants.previosOrderUserLang));
    ...
    if (mounted) {
      RestClient(ApiHeader().dioData())
        ...
        if (sucess = true) {
          ...
          setState(() {
            PreferenceUtils.setString(Constants.previosOrderStatus, "COMPLETE");
          });
