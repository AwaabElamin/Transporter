...
<section class="section">
    ...
    <div class="section-body">
        <h2 class="section-title">{{__("Vendor Finance Management")}}</h2>
                ...
                <div class="w-100">
                    <div class="row">
                        ...
                        <div class="col text-right">
                            <a href="{{ url('vendor/month_finanace') }}">{{__('View all')}}</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-header text-right">
                ...
                <span class="badge badge-success">{{__('SDG vendor gives to admin')}}</span>&nbsp;
                <span class="badge badge-danger">{{__('SDG admin gives to vendor')}}</span>
            </div>
            <div class="card-body">
