...
<section class="section">
        ...
        <div class="section-body">
            ...
            <form class="container-fuild" action="{{ url('vendor/vendor/'.$vendor->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="card mt-2">
                    <div class="card-header">
                        <h6 class="c-grey-900">{{__('Select Tags (For Seller it will be categorys)')}}</h6>
                    </div>
                    <div class="card-body">
                        <div class="mT-30">
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <select class="select2 form-control" name="category_id[]" multiple="true">
                                        @foreach ($categorys as $category)
                                            <option value="{{$category->id}}" {{in_array($category->id,explode(',',$vendor->category_id)) ? 'selected' : ''}}>{{ $category->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('category_id')
                                    <span class="custom_error" role="alert">
