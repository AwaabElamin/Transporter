    ...
    <aside id="sidebar-wrapper  p-3">
        ...
        <ul class="sidebar-menu">
            ...
            @endcan
             ...
             <li class="dropdown {{ $activePage == 'storage' ? 'active' : ''}} || {{ $activePage == 'incoming' ? 'active' : ''}} || {{ $activePage == 'exporting' ? 'active' : ''}}">
                    <a href="javascript:void(0);" class="nav-link has-dropdown">
                        <i class="fas fa-archive text-danger"></i>
                        <span>{{__('Storage')}}</span>
                    </a>
                    <ul class="dropdown-menu" style="display: none;">
                        <li class="{{ $activePage == 'incoming' ? 'active' : ''}}"><a href="{{ url('admin/warehouse/incoming') }}">{{__('Warehouse incoming')}}</a></li>
                        <li class="{{ $activePage == 'exporting' ? 'active' : ''}}"><a href="{{ url('admin/warehouse/exporting') }}">{{__('Warehouse exporting')}}</a></li>
                        <li class="{{ $activePage == 'storage' ? 'active' : ''}}"><a href="{{ url('admin/storage') }}">{{__('Inventory')}}</a></li>
                    </ul>
                </li>

            <!-- <li class="{{ $activePage == 'storage' ? 'active' : '' }}">
