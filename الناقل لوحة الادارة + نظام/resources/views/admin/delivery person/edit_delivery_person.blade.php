                ...
                <div class="card-body">
                    <div class="mT-30">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-5">
                                <label for="{{__('Percent')}}">{{__('Percent')}}<span class="text-danger">&nbsp;*</span></label>
                                <input type="number" min="0" max="100" name="percent" value="{{ $delivery_person->percent }}"
                                    class="form-control @error('percent') is_invalide @enderror" placeholder="{{__('percent')}}">
