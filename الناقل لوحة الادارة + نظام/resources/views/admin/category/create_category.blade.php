    ...
    <section class="section">
        ...
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item active"><a href="{{ url('admin/category') }}">{{__('Create category')}}</a></div>
        ...
        <div class="section-body">
            ...
            <form class="container-fuild" action="{{ url('admin/category') }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card p-2">
                    <div class="card-body">
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                <label for="">{{__('Name of Category')}}<span class="text-danger">&nbsp;*</span></label>
                                <input type="text" name="name" placeholder="{{__('Enter Category Name')}}" class="form-control @error('name') is_invalide @enderror" required="true">
                                @error('name')
                                    <span class="custom_error" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
