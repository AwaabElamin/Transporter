...
<head>
    ...
    @endphp
    <title>{{ $title }} | @yield('title','Admin forgot password')</title>
                    ...
                    <div class="p-4 m-3">
                        ...
                        <form method="POST" action="{{ url('admin/admin_forgot_password') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input id="email" type="email" class="form-control" placeholder="{{__('Please Enter Your Email Id')}}" name="email" tabindex="1" required autofocus>
                            </div>
