    ...
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="{{ url('admin/vendor') }}">{{__('vendor')}}</a></div>
             <div class="breadcrumb-item"><a href="{{ url('admin/vendor/'.$id) }}">{{ $vendor->name }}</a></div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-12 col-md-6 col-lg-6 col-xl-8 orderColRight">
                                                                <div class="orderContent">
                                                                    ...
                                                                    @else
                                                                        <img src="{{ url('images/used items.png') }}" class="orderIcon" alt="">
                                                                    @endif
                                                                    <h5>{{ $submenu->name }}</h5>
                                                                </div>
...
<div class="modal fade right" id="view_custimization" data-keyboard="false" tabindex="-1"
    ...
    <form action="{{ url('admin/order/update_custimization') }}" method="post">
        @csrf
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
