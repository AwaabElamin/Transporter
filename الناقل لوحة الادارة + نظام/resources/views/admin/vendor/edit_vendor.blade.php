            ...
            <div class="card mt-2">
                ...
                <div class="card-body">
                    <div class="mT-30">
                        ...
                        <input type="number" max=100 min=1 name="sp" placeholder="{{__('Small Package')}}" value="{{ $vendor->sp }}" required class="form-control  @error('sp') invalid @enderror">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" max=100 min=1 name="mp" placeholder="{{__('Medium Package')}}" value="{{ $vendor->mp }}" required class="form-control  @error('mp') invalid @enderror">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" max=100 min=1 name="lp" placeholder="{{__('Large Package')}}" value="{{ $vendor->lp }}" required class="form-control  @error('lp') invalid @enderror">
