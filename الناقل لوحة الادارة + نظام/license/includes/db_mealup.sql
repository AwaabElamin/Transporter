...
(2, 'العربية', 'العربية.json', 'arabic.png', 'ltr', 1, '2021-02-08 05:55:04', '2021-02-13 08:45:16');
...
CREATE TABLE `notification_template` (
  ...
  `arabic_notification_content` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `arabic_mail_content` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `notification_template` (`id`, `subject`, `title`, `notification_content`, `mail_content`, `arabic_notification_content`, `arabic_mail_content`, `created_at`, `updated_at`) VALUES
...
CREATE TABLE `vendor` (
  ...
  `sp` varchar(4) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `mp` varchar(4) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `lp` varchar(4) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
