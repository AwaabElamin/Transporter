...
Route::middleware(['auth'])->prefix('admin')->group(function ()
{
    ...
    Route::resources([
        ...
        'storage'=>Admin\StorageController::class,
    ...
    Route::get('warehouse/incoming',[StorageController::class, 'incoming']);
    Route::get('warehouse/exporting',[StorageController::class, 'exporting']);
    ...
    Route::post('cart',[VendorController::class,'cart']);
    Route::get('DispCustimization/{submenu_id}',[VendorController::class,'custimization']);
    Route::post('update_custimization',[VendorController::class,'update_custimization']);
    Route::post('add_user',[VendorController::class,'add_user']);
    Route::get('display_bill',[VendorController::class,'display_bill']);
    Route::post('displayBillWithCoupen',[VendorController::class,'displayBillWithCoupen']);
    Route::post('change_submenu',[VendorController::class,'change_submenu']);
    Route::post('order/change_status',[VendorController::class,'change_status']);
    ...
    // Route::resource('customization_item', SubmenuCustomizationItemController::class)->except([
    //     'index','create'
    // ]);
    ...
    Route::get('vendor/{id}/order',[VendorController::class,'order']);
    ...
    Route::post('vendor_tax',[VendorController::class,'vendor_tax']);

    Route::post('driver_tax',[DeliveryPersonController::class,'driver_tax']);
    ...
    Route::post('storage/change_storage_status',[StorageController::class, 'change_storage_status']);
    Route::post('delivery_person/change_status',[DeliveryPersonController::class, 'change_status']);
    Route::post('delivery_person/change_zoner',[DeliveryPersonController::class, 'change_zoner']);
    ...
    // Multi Delete
    Route::post('/category_multi_delete',[multiDeleteController::class,'category_delete']);
