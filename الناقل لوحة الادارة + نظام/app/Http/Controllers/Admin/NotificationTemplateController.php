...
class NotificationTemplateController extends Controller
{
    ...
    public function index()
    {
        if (session()->has('locale'))
        {
            ...
            if ($lang == "العربية") 
            {
                ...
                {
                    $value->notification_content = $value->arabic_notification_content;
                    $value->mail_content = $value->arabic_mail_content;
                }
            }
            else
            {
    ...
    public function edit(NotificationTemplate $notificationTemplate)
    {
        if (session()->has('locale')) 
        {
            ...
            if ($lang == "العربية") 
            {
                $notificationTemplate->notification_content = $notificationTemplate->arabic_notification_content;
                $notificationTemplate->mail_content = $notificationTemplate->arabic_mail_content;
            }
        }
    ...
    public function update(Request $request, NotificationTemplate $notificationTemplate)
    {
        ...
        if (session()->has('locale')) 
        {
            ...
            if ($lang == "العربية") 
            {
                $notificationTemplate->arabic_notification_content = $data['notification_content'];
                $notificationTemplate->arabic_mail_content = $data['mail_content'];
