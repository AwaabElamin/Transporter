...
<section class="section">
    ...
    <div class="section-body">
        ...
        <form class="container-fuild" action="<?php echo e(url('admin/language')); ?>" method="post" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            <div class="card p-2">
                <div class="card-body">
                    <div class="row">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <label for=""><?php echo e(__('Name of Language')); ?>(<?php echo e(__("cann't edit")); ?>)<span class="text-danger">&nbsp;*</span></label>
...
unset($__errorArgs, $__bag); ?>" required="true" style="text-transform: none">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <label for=""><?php echo e(__('Language Json File')); ?><span class="text-danger">&nbsp;*</span></label>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            <label for=""><?php echo e(__('Language Direction')); ?><span class="text-danger">&nbsp;*</span></label>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="text-center mt-3">
                        <button type="submit" class="btn btn-primary"><?php echo e(__('Create Language')); ?></button>
                    </div>
                </div>
            </div>
        </form>
...
<?php echo $__env->make('layouts.app',['activePage' => 'language'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mobark/dev.transporter-sudan.com/resources/views/admin/language/create_language.blade.php ENDPATH**/ ?>