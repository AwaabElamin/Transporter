                    ...
                    <?php
                        if (session::has('locale')) 
                        {
                            ...
                            if ($lang == 'العربية') 
                            {
                                ...
                                $item->mail_content = $item->arabic_mail_content;
                                $item->notification_content = $item->arabic_notification_content;
                            }
                            else
                            {
                                $item = App\Models\NotificationTemplate::where('title','book order')->first();    
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="notification_content" id="notification_content" name="notification_content" class="form-control" cols="30" rows="10" style="text-transform: none"><?php echo e($item->notification_content); ?></textarea>
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="mail_content" class="form-control textarea_editor" cols="10" rows="10" id="mail_content" style="text-transform: none"><?php echo e($item->mail_content); ?></textarea>
                                                    </div>
                                                </div>
                                            </div>
...
<?php echo $__env->make('layouts.app',['activePage' => 'notification_template'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mobark/dev.transporter-sudan.com/resources/views/admin/notification template/notification_template.blade.php ENDPATH**/ ?>