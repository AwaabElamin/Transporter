<?php $__env->startSection('title','Warehouse exporting'); ?>

<?php $__env->startSection('content'); ?>

<section class="section">
    <div class="section-header">
        <h1><?php echo e(__('Warehouse exporting')); ?></h1>
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><?php echo e(__('Warehouse exporting')); ?></div>
        </div>
    </div>
    <div class="section-body">
        <h2 class="section-title"><?php echo e(__('storage page')); ?></h2>
        <p class="section-lead"><?php echo e(__('Warehouse exporting')); ?></p>
        <div class="card">
            
                <div class="card-header">
                <h4><?php echo e(__('Warehouse exporting')); ?></h4>
...
<?php echo $__env->make('layouts.app',['activePage' => 'exporting'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/dev.transporter-sudan.com/resources/views/admin/storage/exporting.blade.php ENDPATH**/ ?>