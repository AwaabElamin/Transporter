                    ...
                    <table id="datatable" class="table table-striped table-bordered text-center" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="javascript:void(0);" class="table-action ml-2 btn btn-primary btn-action" onclick="deleteData('admin/faq',<?php echo e($faq->id); ?>,'Faq')">
...
<?php echo $__env->make('layouts.app',['activePage' => 'faq'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mobark/dev.transporter-sudan.com/resources/views/admin/faq/faq.blade.php ENDPATH**/ ?>