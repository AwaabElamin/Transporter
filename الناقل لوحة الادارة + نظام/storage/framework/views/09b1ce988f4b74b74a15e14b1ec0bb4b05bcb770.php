<?php $__env->startSection('title','Warehouse incoming'); ?>

<?php $__env->startSection('content'); ?>

<section class="section">
    <div class="section-header">
        <h1><?php echo e(__('Warehouse incoming')); ?></h1>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a href="<?php echo e(url('admin/home')); ?>"><?php echo e(__('Dashboard')); ?></a></div>
            <div class="breadcrumb-item active"><a href="<?php echo e(url('admin/storage')); ?>"><?php echo e(__('Inventory')); ?></a></div>
            <div class="breadcrumb-item"><?php echo e(__('Warehouse incoming')); ?></div>
        </div>
    </div>
    <div class="section-body">
        <h2 class="section-title"><?php echo e(__('storage page')); ?></h2>
        <p class="section-lead"><?php echo e(__('Warehouse incoming')); ?></p>
        <div class="card">
            
                <div class="card-header">
                <h4><?php echo e(__('Warehouse incoming')); ?></h4>
...
unset($__errorArgs, $__bag); ?>" onchange="change_storage_status(this,<?php echo e($order->id); ?>)">
                                ...
                                <th>
                                    <a href="javascript:void(0);" class="table-action btn btn-success btn-action" onclick="change_storage_status(this,<?php echo e($order->id); ?>)">
...
<?php echo $__env->make('layouts.app',['activePage' => 'incoming'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/dev.transporter-sudan.com/resources/views/admin/storage/incoming.blade.php ENDPATH**/ ?>