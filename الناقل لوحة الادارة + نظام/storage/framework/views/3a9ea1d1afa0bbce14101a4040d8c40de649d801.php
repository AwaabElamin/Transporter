...
<head>
    ...
    <?php
        $name = App\Models\GeneralSetting::find(1)->business_name;
        $favicon = App\Models\GeneralSetting::find(1)->favicon;
       $title = View::getSection('title', 'title')
    ?>

    <title><?php echo e($name); ?> | <?php echo e(__($title)); ?></title>
...
<body>
                    ...
                    <script>
                        ...
                        if (window.location.origin + window.location.pathname != $('#mainurl').val() + '/admin/license_setting')
                        {
                            setTimeout(() =>
                            {
                                ...
                                icon: 'info',
                                html: 'to get benifit of alnaqel please activate your license<br><br>'+
    ...
    <?php if(Request::is('admin/vendor/*') || Request::is('admin/vendor/create') || Request::is('vendor/vendor/*') || Request::is('vendor/update_vendor')): ?>
    ...
    <?php if(Request::is('vendor/order/create')): ?>
        
        <script src="<?php echo e(asset('js/order.js')); ?>"></script>
    <?php endif; ?>
    <?php if(Request::is('admin/vendor/*/order')): ?>
        
        <script src="<?php echo e(asset('js/admin/order.js')); ?>"></script>
    <?php endif; ?>

    <?php if(Request::is('admin/delivery_zone_area/*') || Request::is('vendor/deliveryZoneArea/*')): ?>
        <script src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(App\Models\GeneralSetting::first()->map_key); ?>&libraries=places&callback=initMap&libraries=places&v=weekly" defer></script>
    ...
    <script src="<?php echo e(asset('js/admin/custom.js')); ?>"></script>
     <?php endif; ?>
     <?php if(Request::is('vendor/*')): ?>
    <script src="<?php echo e(asset('js/custom.js')); ?>"></script>
     <?php endif; ?>
</body>

</html>
<?php /**PATH /var/www/html/dev.transporter-sudan.com/resources/views/layouts/app.blade.php ENDPATH**/ ?>