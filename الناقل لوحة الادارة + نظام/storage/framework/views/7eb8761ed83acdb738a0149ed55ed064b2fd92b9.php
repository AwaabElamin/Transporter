    ...
    <aside id="sidebar-wrapper  p-3">
        ...
        <ul class="sidebar-menu">
            ...
            <?php endif; ?>
             ...
             <li class="dropdown <?php echo e($activePage == 'storage' ? 'active' : ''); ?> || <?php echo e($activePage == 'incoming' ? 'active' : ''); ?> || <?php echo e($activePage == 'exporting' ? 'active' : ''); ?>">
                    <a href="javascript:void(0);" class="nav-link has-dropdown">
                        <i class="fas fa-archive text-danger"></i>
                        <span><?php echo e(__('Storage')); ?></span>
                    </a>
                    <ul class="dropdown-menu" style="display: none;">
                        <li class="<?php echo e($activePage == 'incoming' ? 'active' : ''); ?>"><a href="<?php echo e(url('admin/warehouse/incoming')); ?>"><?php echo e(__('Warehouse incoming')); ?></a></li>
                        <li class="<?php echo e($activePage == 'exporting' ? 'active' : ''); ?>"><a href="<?php echo e(url('admin/warehouse/exporting')); ?>"><?php echo e(__('Warehouse exporting')); ?></a></li>
                        <li class="<?php echo e($activePage == 'storage' ? 'active' : ''); ?>"><a href="<?php echo e(url('admin/storage')); ?>"><?php echo e(__('Inventory')); ?></a></li>
                    </ul>
                </li>

            <!-- <li class="<?php echo e($activePage == 'storage' ? 'active' : ''); ?>">
                <a class="nav-link" href="<?php echo e(url('admin/storage')); ?>">
                    <i class="fas fa-archive text-danger"></i>
                    <span><?php echo e(__('Storage')); ?></span>
                </a>
            </li> -->
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('notification_template_access')): ?>
                <li class="<?php echo e($activePage == 'notification_template' ? 'active' : ''); ?>">
                    <a class="nav-link" href="<?php echo e(url('admin/notification_template')); ?>">
                        <i class="fas fa-address-card text-danger"></i>
                        <span class="nav-link-text"><?php echo e(__('Notification Template')); ?></span>
                    </a>
                </li>
            <?php endif; ?>
...
<?php /**PATH /var/www/html/dev.transporter-sudan.com/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>