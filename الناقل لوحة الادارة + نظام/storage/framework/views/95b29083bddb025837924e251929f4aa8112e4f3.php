    ...
    <div class="section-body">
            ...
            <div class="col">
                <div class="card card-primary rounded-lg">
                    <div class="card-header">
                        <h5><?php echo e(__("Day to Day Order Management Records")); ?></h5>
                    </div>
                    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-12 col-12 col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h4><?php echo e(__('Avarage Time of Vendors')); ?></h4>
                    </div>
                    <div class="card-body">
                                ...
                                <a class="ticket-item">
                                    ...
                                    <div class="ticket-info">
                                        ...
                                        <div class="w-100">
                                            ...
                                            <?php else: ?>
                                                <img src="<?php echo e(url('images/used items.png')); ?>" class="float-right" alt="">
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </a>
...
<?php echo $__env->make('layouts.app',['activePage' => 'home'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/dev.transporter-sudan.com/resources/views/admin/home.blade.php ENDPATH**/ ?>