    ...
    $.ajax(
        {
            ...
            type: "POST",
            url: base_url + '/admin/change_submenu',
            data:
            {
                menu_id: menu_id,
            },
            success: function (result)
            {
                ...
                for (let i = 0; i < result.data.length; i++)
                {
                    ...
                    {
                        icon = '<img src="'+base_url+'/images/used items.png" alt="" class="orderIcon">';
                    }
            ...
            $.ajax(
                {
                    ...
                    type: "post",
                    url: base_url + "/admin/update_custimization",
                    data:
                    {
        ...
        $.ajax(
            {
                ...
                type: "GET",
                url: base_url + '/admin/display_bill',
                success: function (result) {
                    if (result.success == true)
                    {
...
function displayBillWithCoupen(id)
{
    ...
    $.ajax(
    {
        ...
        type: "POST",
        url: base_url + '/admin/displayBillWithCoupen',
        data:
        {
            promo_id: id,
            user_id: user_id,
...
function confirm_order()
{
    $.ajax(
    {
        ...
        success: function (result)
        {
            ...
            if (result.success == true)
            {
                location.replace(base_url + '/admin/order');
            }
        },
        error: function (err) {
            console.log('err ', err)
...
function cart(id, operation)
{
    ...
    $.ajax({
        ...
        success: function (result)
        {
            console.log('cart called and respone is'+result);
                
            if (result.success == true) {
                console.log('worked and the data is');
                ...
                console.log('Not worked and the data is');
                console.log(result.data);
                swal({
                    text: result.data,
                });
...
function DispCustimization(submenu_id) {
    $.ajax(
    {
        ...
        type: "GET",
        url: base_url + '/admin/DispCustimization/' + submenu_id,
        success: function (result)
        {
            if (result.success == true)
            {
