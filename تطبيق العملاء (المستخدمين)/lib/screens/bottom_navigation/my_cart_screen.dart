...
import 'package:alnaqel_user/model/apply_promocode_model.dart';
...
import 'package:alnaqel_user/model/customization_item_model.dart';
...
import 'package:alnaqel_user/screens/address/add_address_screen.dart';
import 'package:alnaqel_user/screens/address/edit_address_screen.dart';
import 'package:alnaqel_user/screens/auth/login_screen.dart';
import 'package:alnaqel_user/screens/payment_method_screen.dart';
import 'package:alnaqel_user/utils/SharedPreferenceUtil.dart';
import 'package:alnaqel_user/utils/app_toolbar.dart';
import 'package:alnaqel_user/utils/constants.dart';
import 'package:alnaqel_user/utils/database_helper.dart';
                                                                                      ...
                                                                                      child: Column(
                                                                                        children: [
                                                                                          ...
                                                                                          Text(
                                                                                            ...
                                                                                            style: TextStyle(fontFamily: Constants.appFont, fontSize: ScreenUtil().setSp(12), color: Color(Constants.colorTheme)),
                                                                                          ),
                                                                                          Padding(
                                                                                            padding: EdgeInsets.only(top: ScreenUtil().setHeight(12)),
                                                                                            child: Text(
                                                                                              ...
                                                                                              style: TextStyle(color: Color(Constants.colorGray), fontFamily: Constants.appFont, fontSize: ScreenUtil().setSp(12)),
                                                                                            ),
                                                                                          )
                                                                                        ],
                                                                                      ),
...
//     for (int i = 0; i < _listOtherTax.length; i++) {
//       if (_listOtherTax[i].type == 'percentage') {
//         tempVar = subTotal * double.parse(_listOtherTax[i].tax.toString()) / 100;
//         sendAllTax.add({
//           'tax': tempVar,
//           'name': _listOtherTax[i].name,
//         });
...
//
//                                           SharedPreferenceUtil.putString(
//                                               'selectedLat', _userAddressList[index].lat!);
//                                           SharedPreferenceUtil.putString(
//                                               'selectedLng', _userAddressList[index].lang!);
...
//           });
//         } else if (strOrderSettingDeliveryChargeType == 'delivery_distance') {
//           double userLat = double.parse(SharedPreferenceUtil.getString('selectedLat')),
//               userLong = double.parse(SharedPreferenceUtil.getString('selectedLng')),
//               vendorLat = double.parse(vandorLat),
//               vendorLong = double.parse(vandorLong);
//
//           var p = 0.017453292519943295;
