...
class _SingleCuisineDetailsScreenState
                                                              ...
                                                              margin: EdgeInsets.only(
                                                                  right: ScreenUtil()
                                                                      .setWidth(
                                                                          10)),
                                                              child: (() {
                                                                if (_listCuisineVendorRestaurants[
                                                                            index]
                                                                        .vendorType ==
                                                                    'veg') {
                                                                  return Row(
  ...
  Future<BaseModel<CuisineVendorDetailsModel>> getCallSingleCuisineDetails(
      cuisineId) async {
    ...
    try {
      ...
      response =
          await RestClient(RetroApi().dioData()).cuisineVendor(cuisineId);
      setState(() {
        _isSyncing = false;
