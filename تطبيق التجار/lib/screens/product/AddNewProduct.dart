...
import 'package:alnaqel_seller/screens/product/AddNewItem.dart';
          ...
          children: [
                ...
                child: Center(
                  child: Container(
                    ...
                    child: FutureBuilder<BaseModel<Menu>>(
                      future:
                          menuFuture!.then((value) => value as BaseModel<Menu>),
            ...
            Padding(
              ...
              child: GestureDetector(
                onTap: () {
                  _image = null;
                  _displayAddMenuDialog(
                      context); //_displayAddMenuDialog(context);
                },
                child: Row(
                  children: [
                    Icon(
        ...
        onPressed: () {
          if (selectedItemId != null) {
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                  builder: (context) => AddNewItem(dropdownValue, false, null)),
            );
          } else {
            DeviceUtils.toastMessage('Please Select Type');
          }
        },
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Container(
                                    width: 30.w,
                                    child: Text(
                                      getTranslated(context, add_item_image)!,
