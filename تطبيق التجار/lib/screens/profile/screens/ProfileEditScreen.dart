...
class _ProfileEditScreenState extends State<ProfileEditScreen> {
  ...
  void initState() {
    ...
    if (vendorTypeValue == 'all') {
      vendorTypeValue = 'All';
    } else if (vendorTypeValue == 'New Items only') {
      vendorTypeValue = 'New';
    } else if (vendorTypeValue == 'Used Items only') {
      vendorTypeValue = 'Used';
    } else {
      vendorTypeValue = 'All';
    }
  }
                          ...
                          children: [
                            Container(
                              ...
                              child: ClipRRect(
                                  ...
                                  child: item_Image != null
                                      ? showImage()
                                      : Image(
                                          image:
                                              NetworkImage(data!.vendorLogo!),
                                          fit: BoxFit.fill,
                                        )),
                            ),
                            Container(
      ...
      bottomNavigationBar: GestureDetector(
        onTap: () async {
          if (restaurantController.text.isEmpty) {
            ...
            if (imageFile != null) {
              try {
                List<int> imageBytes = item_Image!.readAsBytesSync();
            ...
            param['for_two_person'] = cost_of_two_person;
            param['avg_delivery_time'] = avg_delivery_time;
            ...
            await updateProfileVendor(param).then((value) => value.data != null
